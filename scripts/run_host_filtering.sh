...
READ_DIR=~/shotgun_data/kvass_project/data/processed/trimmed_reads
OUT_DIR=~/shotgun_data/kvass_project/data/processed/host_filtered_reads
HOST_INDEX=~/shotgun_data/kvass_project/genomes/combined_hosts
